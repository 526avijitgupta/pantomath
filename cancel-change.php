	...
	<div class="container col-xs-12"> 
		...
		<div class="row content-container">
			...
			<div class="col-sm-7 content-sub-container" id="flights-content">
				...
				<form role="form" action="cancel-change.php" method="post">
				<select name="select">
				...
				<button type="submit" formaction="cancel-change.php" name="submit">Submit</button>
			</form>
         	...
         	require("connection.php");
		     	...
		     	$_SESSION['tablename'] = $tablename;
				   ...
				   //  	echo "OKAY";
        			...
        			print "<form action='cancelled-orders.php' method='post'>";
            ...
            print "<input type='submit' value='cancel'></td>";
            print "</form>";
          print "</table>"; 
        }
        }
