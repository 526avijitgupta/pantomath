...
<aside class="btn-group-vertical" id="left-aside-menu" style="float:left;">
	<button type="button" class="btn btn-default" id="index" title="Find flights from and to international destinations around the world" onclick="location.href='index.php'">
		<span class="ion-plane left-aside-ionicons"></span>
		&nbsp;&nbsp;Flights&nbsp;&nbsp;&nbsp;
		<span class="ion-ios7-arrow-right fwd-right"></span>
	</button>
	<button type="button" class="btn btn-default" id="hotels" title="Find hotels in destinations around the world" onclick="location.href='hotels.php'">
...
<!-- 	<button type="button" class="btn btn-default" id="trains" title="Find trains to destinations within India" onclick="location.href='trains.php'">
	...
	<button type="button" class="btn btn-default" id="mobile" title="Cleartrip Mobile" onclick="location.href='mobile.php'">
